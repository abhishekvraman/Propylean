...
class test_PressureGuage(unittest.TestCase):
    ...
    @pytest.mark.positive
    @pytest.mark.instantiation
    def test_PressureGuage_instantiation_tag_and_pressure_drop(self):
        flow_meter = PressureGuage(tag="flow_meter_2",
    ...
    def test_PressureGuage_representation(self):
        flow_meter = PressureGuage(tag="flow_meter_5")
        self.assertIn("Flow Meter with tag: flow_meter_5", str(flow_meter))
    
    @pytest.mark.positive
    def test_PressureGuage_setting_inlet_pressure(self):
        flow_meter = PressureGuage(tag="flow_meter_6",
    ...
    @pytest.mark.positive
    def test_PressureGuage_setting_outlet_pressure(self):
        flow_meter = PressureGuage(tag="flow_meter_7",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_setting_inlet_temperature(self):
        flow_meter = PressureGuage(tag="flow_meter_8",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_setting_outlet_temperature(self):
        flow_meter = PressureGuage(tag="flow_meter_9",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_setting_inlet_mass_flowrate(self):
        flow_meter = PressureGuage(tag="flow_meter_10",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_setting_outlet_mass_flowrate(self):
        flow_meter = PressureGuage(tag="flow_meter_11",
    ...
    @pytest.mark.positive
    def test_PressureGuage_connection_with_material_stream_inlet_stream_governed(self):
        flow_meter = PressureGuage(tag="flow_meter_12",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_connection_with_material_stream_outlet_stream_governed(self):
        flow_meter = PressureGuage(tag="flow_meter_13",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_connection_with_material_stream_inlet_equipment_governed(self):
        flow_meter = PressureGuage(tag="flow_meter_14",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_connection_with_material_stream_outlet_equipment_governed(self):
        flow_meter = PressureGuage(tag="flow_meter_15",
                          pressure_drop=(0.1, 'bar'))
    ...
    # pytest.mark.positive
    # def test_PressureGuage_connection_with_energy_stream_inlet_equipment_governed(self):
    #     flow_meter = PressureGuage(tag="flow_meter_17",
    #                       pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_stream_disconnection_by_stream_object(self):
        flow_meter = PressureGuage(tag="flow_meter_18",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    @pytest.mark.temp
    def test_PressureGuage_stream_disconnection_by_stream_tag(self):
        flow_meter = PressureGuage(tag="flow_meter_19",
                          pressure_drop=(0.1, 'bar'))
    ...
    @pytest.mark.positive
    def test_PressureGuage_stream_disconnection_by_direction_stream_type(self):
        flow_meter = PressureGuage(tag="flow_meter_20",
                          pressure_drop=(0.1, 'bar'))
    ...
    def test_PressureGuage_inlet_pressure_incorrect_type_to_value(self):
    ...
    @pytest.mark.negative
    def test_PressureGuage_outlet_pressure_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
            m4.outlet_pressure = []
    ...
    @pytest.mark.negative
    def test_PressureGuage_pressure_drop_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
            m4.pressure_drop = []
    ...
    @pytest.mark.negative
    def test_PressureGuage_inlet_temperature_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_outlet_temperature_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_temperature_decrease_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_temperature_increase_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_design_temperature_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_inlet_mass_flowrate_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_outlet_mass_flowrate_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_energy_in_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
            m4.energy_in = []
    ...
    @pytest.mark.negative
    def test_PressureGuage_energy_out_incorrect_type_to_value(self):
        with pytest.raises(Exception) as exp:
            m4 = PressureGuage()
            m4.energy_out = []
    ...
    @pytest.mark.negative
    def test_PressureGuage_stream_connecion_disconnection_incorrect_type(self):
        cv = PressureGuage()
    ...
    @pytest.mark.negative
    def test_PressureGuage_stream_disconnection_before_connecion(self):  
        cv = PressureGuage()
        inlet_stream = MaterialStream(pressure=(20, 'bar'))
        inlet_stream.components = prop.Components({"water": 1})
        import warnings
    ...
    @pytest.mark.mapping
    def test_PressureGuage_stream_equipment_mapping(self):
        ...
        flow_meter = PressureGuage(pressure_drop=(0.1, 'bar'))
        inlet_stream = MaterialStream(pressure=(20, 'bar'))
        inlet_stream.components = prop.Components({"water": 1})
    ...
    @pytest.mark.delete 
    def test_PressureGuage_stream_equipment_delete_without_connection(self):
        flow_meter = PressureGuage(pressure_drop=(0.1, 'bar'))   
        print(flow_meter)
        flow_meter.delete()
        with pytest.raises(Exception) as exp:
